...
Minimal SQL reference documentation for advanced topics, focused on practical use with **Databricks** and **Fabric/Power BI**.
...
- Platform-specific notes for Databricks and Fabric
- Portable SQL patterns preferred
- Dynamic SQL workarounds where applicable
